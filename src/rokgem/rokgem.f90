MODULE rokgem
  ...
  PUBLIC :: cpl_flux_rokatm
  PUBLIC :: cpl_flux_rokocn
CONTAINS
  ...
  SUBROUTINE step_rokgem(dum_dts, dum_sfcatm1, dum_runoff, dum_photo, dum_respveg, dum_sfxrok, dum_sfxatm1)
    ...
    REAL, INTENT(IN) :: dum_runoff(:,:)      ! run-off to be read in from exernal module (EMBM, or ENTS)
    ...
    REAL, INTENT(INOUT) :: dum_sfxrok(:,:,:)  ! ocean flux interface array
