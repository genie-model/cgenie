...
MODULE rokgem_lib
  ...
  ! ------------------- I/O DEFINITIONS ------------------------------------------------------------------------------------------ !
  CHARACTER(len=255)::par_indir_name,par_outdir_name,par_rstdir_name                     !
  ...
  NAMELIST /ini_rokgem_nml/opt_weather_C_Ca,opt_weather_C_Si
  ...
  NAMELIST /ini_rokgem_nml/par_k_Ca,par_k_Si,par_E_a,par_k_run,par_beta
  ...
  NAMELIST /ini_rokgem_nml/par_weather_CaSiO3,par_weather_CaSiO3_fracMg
