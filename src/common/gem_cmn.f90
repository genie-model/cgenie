...
MODULE gem_cmn
  ...
  INTEGER,PARAMETER::ias_pCO2_13C                         = 04    ! 13C (pCO2)
  INTEGER,PARAMETER::ias_pCO2_14C                         = 05    ! 14C (pCO2)
  INTEGER,PARAMETER::ias_pO2                              = 06    ! pO2
  INTEGER,PARAMETER::ias_pO2_18O                          = 07    ! 18O (pO2)
  INTEGER,PARAMETER::ias_pN2                              = 08    ! pN2
  INTEGER,PARAMETER::ias_pN2_15N                          = 09    ! 15N (pN2)
  INTEGER,PARAMETER::ias_pCH4                             = 10    ! pCH4
  INTEGER,PARAMETER::ias_pCH4_13C                         = 11    ! 13C (pCH4)
  INTEGER,PARAMETER::ias_pCH4_14C                         = 12    ! 14C (pCH4)
  INTEGER,PARAMETER::ias_pSF6                             = 13    ! halo-carbon
  INTEGER,PARAMETER::ias_pN2O                             = 14    ! pN2
  INTEGER,PARAMETER::ias_pN2O_15N                         = 15    ! 15N (pN2)
  INTEGER,PARAMETER::ias_pH2S                             = 16    ! pH2S
  ...
  INTEGER,PARAMETER::iss_POC_13C                           = 04    !
  INTEGER,PARAMETER::iss_POC_14C                           = 05    !
  INTEGER,PARAMETER::iss_PON                               = 06    !
  INTEGER,PARAMETER::iss_PON_15N                           = 07    !
  INTEGER,PARAMETER::iss_POP                               = 08    !
  INTEGER,PARAMETER::iss_POCd                              = 09    !
  INTEGER,PARAMETER::iss_POCd_114Cd                        = 43    !
  INTEGER,PARAMETER::iss_POFe                              = 10    !
  INTEGER,PARAMETER::iss_POI                               = 79    !
  INTEGER,PARAMETER::iss_POM_231Pa                         = 11    !
  INTEGER,PARAMETER::iss_POM_230Th                         = 12    !
  INTEGER,PARAMETER::iss_POM_Fe                            = 13    !
  INTEGER,PARAMETER::iss_POM_Fe_56Fe                       = 75    !
  INTEGER,PARAMETER::iss_POM_Nd                            = 47    !
  INTEGER,PARAMETER::iss_POM_Nd_144Nd                      = 48    !
  INTEGER,PARAMETER::iss_POM_MoS2                          = 58    !
  INTEGER,PARAMETER::iss_POM_MoS2_98Mo                     = 59    !
  INTEGER,PARAMETER::iss_POM_MoS2_34S                      = 60    !
  INTEGER,PARAMETER::iss_POM_S                             = 73    !
  INTEGER,PARAMETER::iss_POM_S_34S                         = 74    !
  INTEGER,PARAMETER::iss_CaCO3                             = 14    !
  INTEGER,PARAMETER::iss_CaCO3_13C                         = 15    !
  INTEGER,PARAMETER::iss_CaCO3_14C                         = 16    !
  INTEGER,PARAMETER::iss_CaCO3_18O                         = 17    !
  INTEGER,PARAMETER::iss_CaCO3_44Ca                        = 57    !
  INTEGER,PARAMETER::iss_CdCO3                             = 18    !
  INTEGER,PARAMETER::iss_CdCO3_114Cd                       = 44    !
  INTEGER,PARAMETER::iss_LiCO3                             = 45    !
  INTEGER,PARAMETER::iss_LiCO3_7Li                         = 46    !
  INTEGER,PARAMETER::iss_CaCO3_231Pa                       = 19    !
  INTEGER,PARAMETER::iss_CaCO3_230Th                       = 20    !
  INTEGER,PARAMETER::iss_CaCO3_Fe                          = 21    !
  INTEGER,PARAMETER::iss_CaCO3_Fe_56Fe                     = 76  !
  INTEGER,PARAMETER::iss_CaCO3_Nd                          = 49    !
  INTEGER,PARAMETER::iss_CaCO3_Nd_144Nd                    = 50    !
  INTEGER,PARAMETER::iss_CaCO3_MoS2                        = 61    !
  INTEGER,PARAMETER::iss_CaCO3_MoS2_98Mo                   = 62    !
  INTEGER,PARAMETER::iss_CaCO3_MoS2_34S                    = 63    !
  INTEGER,PARAMETER::iss_det                               = 22    !
  INTEGER,PARAMETER::iss_detLi                             = 55    !
  INTEGER,PARAMETER::iss_detLi_7Li                         = 56    !
  INTEGER,PARAMETER::iss_det_231Pa                         = 23    !
  INTEGER,PARAMETER::iss_det_230Th                         = 24    !
  INTEGER,PARAMETER::iss_det_Fe                            = 25    !
  INTEGER,PARAMETER::iss_det_Fe_56Fe                       = 77    !
  INTEGER,PARAMETER::iss_det_Nd                            = 51    !
  INTEGER,PARAMETER::iss_det_Nd_144Nd                      = 52    !
  INTEGER,PARAMETER::iss_det_MoS2                          = 64    !
  INTEGER,PARAMETER::iss_det_MoS2_98Mo                     = 65    !
  INTEGER,PARAMETER::iss_det_MoS2_34S                      = 66    !
  INTEGER,PARAMETER::iss_opal                              = 26    !
  INTEGER,PARAMETER::iss_opal_30Si                         = 27    !
  INTEGER,PARAMETER::iss_opalGe                            = 28    !
  INTEGER,PARAMETER::iss_opal_231Pa                        = 29    !
  INTEGER,PARAMETER::iss_opal_230Th                        = 30    !
  INTEGER,PARAMETER::iss_opal_Fe                           = 31    !
  INTEGER,PARAMETER::iss_opal_Fe_56Fe                      = 78    !
  INTEGER,PARAMETER::iss_opal_Nd                           = 53    !
  INTEGER,PARAMETER::iss_opal_Nd_144Nd                     = 54    !
  INTEGER,PARAMETER::iss_opal_MoS2                         = 67    !
  INTEGER,PARAMETER::iss_opal_MoS2_98Mo                    = 68    !
  INTEGER,PARAMETER::iss_opal_MoS2_34S                     = 69    !
  INTEGER,PARAMETER::iss_ash                               = 32    !
  INTEGER,PARAMETER::iss_POC_frac2                         = 33    !
  INTEGER,PARAMETER::iss_CaCO3_frac2                       = 34    !
  INTEGER,PARAMETER::iss_opal_frac2                        = 35    !
  INTEGER,PARAMETER::iss_CaCO3_age                         = 36    !
  INTEGER,PARAMETER::iss_det_age                           = 70    !
  INTEGER,PARAMETER::iss_CaCO3_red                         = 71    !
  INTEGER,PARAMETER::iss_CaCO3_blue                        = 72    !
  INTEGER,PARAMETER::iss_foram_p_13C                       = 37    !
  INTEGER,PARAMETER::iss_foram_p_14C                       = 38    !
  INTEGER,PARAMETER::iss_foram_p_18O                       = 39    !
  ...
  integer,parameter::n_itype_max = 22
  ...
  real,dimension(4,nt_atm_all)::par_Sc_coef                                  !
  !  Bunsen Solubility Coefficient coefficients
  real,dimension(6,nt_atm_all)::par_bunsen_coef                              !
