...
CONTAINS
  ...
  SUBROUTINE sub_def_tracerrelationships()
    ...
    conv_sed_ocn(:,:) = 0.0
    conv_sed_ocn(io_DIC,iss_POC)              = 1.0
    conv_sed_ocn(io_DIC_13C,iss_POC_13C)      = 1.0
    conv_sed_ocn(io_DIC_14C,iss_POC_14C)      = 1.0
    conv_sed_ocn(io_PO4,iss_POP)              = 1.0
    conv_sed_ocn(io_NO3,iss_PON)              = 1.0
    conv_sed_ocn(io_NO3_15N,iss_PON_15N)      = 1.0
    conv_sed_ocn(io_ALK,iss_PON)              = -1.0
    conv_sed_ocn(io_Fe,iss_POFe)              = 1.0
    conv_sed_ocn(io_O2,iss_POC)               = -1.0
    conv_sed_ocn(io_O2,iss_PON)               = -1.0
    conv_sed_ocn(io_O2,iss_POP)               = -1.0
    conv_sed_ocn(io_Cd,iss_POCd)              = 1.0
    conv_sed_ocn(io_Cd_114Cd,iss_POCd_114Cd)  = 1.0
    conv_sed_ocn(io_I,iss_POI)                = 1.0
    conv_sed_ocn(io_O2,iss_POI)               = -1.0
    conv_sed_ocn(io_DIC,iss_CaCO3)            = 1.0
    conv_sed_ocn(io_DIC_13C,iss_CaCO3_13C)    = 1.0
    conv_sed_ocn(io_DIC_14C,iss_CaCO3_14C)    = 1.0
    conv_sed_ocn(io_ALK,iss_CaCO3)            = 2.0
    conv_sed_ocn(io_Ca,iss_CaCO3)             = 1.0
    conv_sed_ocn(io_Ca_44Ca,iss_CaCO3_44Ca)   = 1.0
    conv_sed_ocn(io_Cd,iss_CdCO3)             = 1.0
    conv_sed_ocn(io_Cd_114Cd,iss_CdCO3_114Cd) = 1.0
    conv_sed_ocn(io_Li,iss_LiCO3)             = 1.0
    conv_sed_ocn(io_Li_7Li,iss_LiCO3_7Li)     = 1.0
    conv_sed_ocn(io_Li,iss_detLi)             = 1.0
    conv_sed_ocn(io_Li_7Li,iss_detLi_7Li)     = 1.0
    conv_sed_ocn(io_SiO2,iss_opal)            = 1.0
    conv_sed_ocn(io_SiO2_30Si,iss_opal_30Si)  = 1.0
    conv_sed_ocn(io_Ge,iss_opalGe)            = 1.0
    conv_sed_ocn(io_Fe,iss_POM_Fe)            = 1.0
    conv_sed_ocn(io_Fe,iss_CaCO3_Fe)          = 1.0
    conv_sed_ocn(io_Fe,iss_opal_Fe)           = 1.0
    conv_sed_ocn(io_Fe,iss_det_Fe)            = 1.0
    conv_sed_ocn(io_231Pa,iss_POM_231Pa)      = 1.0
    conv_sed_ocn(io_231Pa,iss_CaCO3_231Pa)    = 1.0
    conv_sed_ocn(io_231Pa,iss_opal_231Pa)     = 1.0
    conv_sed_ocn(io_231Pa,iss_det_231Pa)      = 1.0
    conv_sed_ocn(io_230Th,iss_POM_230Th)      = 1.0
    conv_sed_ocn(io_230Th,iss_CaCO3_230Th)    = 1.0
    conv_sed_ocn(io_230Th,iss_opal_230Th)     = 1.0
    conv_sed_ocn(io_230Th,iss_det_230Th)      = 1.0
    conv_sed_ocn(io_Nd,iss_POM_Nd)            = 1.0
    conv_sed_ocn(io_Nd,iss_CaCO3_Nd)          = 1.0
    conv_sed_ocn(io_Nd,iss_opal_Nd)           = 1.0
    conv_sed_ocn(io_Nd,iss_det_Nd)            = 1.0
    conv_sed_ocn(io_Nd_144Nd,iss_POM_Nd_144Nd)   = 1.0
    conv_sed_ocn(io_Nd_144Nd,iss_CaCO3_Nd_144Nd) = 1.0
    conv_sed_ocn(io_Nd_144Nd,iss_opal_Nd_144Nd)  = 1.0
    conv_sed_ocn(io_Nd_144Nd,iss_det_Nd_144Nd)   = 1.0
    conv_sed_ocn(io_H2S,iss_POM_S)               = 1.0
    conv_sed_ocn(io_H2S_34S,iss_POM_S_34S)       = 1.0
    conv_sed_ocn(io_Mo,iss_POM_MoS2)             = 1.0
    conv_sed_ocn(io_H2S,iss_POM_MoS2)            = 2.0
    conv_sed_ocn(io_Mo,iss_CaCO3_MoS2)           = 1.0
    conv_sed_ocn(io_H2S,iss_CaCO3_MoS2)          = 2.0
    conv_sed_ocn(io_Mo,iss_opal_MoS2)            = 1.0
    conv_sed_ocn(io_H2S,iss_opal_MoS2)           = 2.0
    conv_sed_ocn(io_Mo,iss_det_MoS2)             = 1.0
    conv_sed_ocn(io_H2S,iss_det_MoS2)            = 2.0
    conv_sed_ocn(io_Mo_98Mo,iss_POM_MoS2_98Mo)   = 1.0
    conv_sed_ocn(io_H2S_34S,iss_POM_MoS2_34S)    = 2.0
    conv_sed_ocn(io_Mo_98Mo,iss_CaCO3_MoS2_98Mo) = 1.0
    conv_sed_ocn(io_H2S_34S,iss_CaCO3_MoS2_34S)  = 2.0
    conv_sed_ocn(io_Mo_98Mo,iss_opal_MoS2_98Mo)  = 1.0
    conv_sed_ocn(io_H2S_34S,iss_opal_MoS2_34S)   = 2.0
    conv_sed_ocn(io_Mo_98Mo,iss_det_MoS2_98Mo)   = 1.0
    conv_sed_ocn(io_H2S_34S,iss_det_MoS2_34S)    = 2.0
    ! convert dissolved species -> solid
    conv_ocn_sed(:,:) = 0.0
    conv_ocn_sed(iss_POC,io_DIC)              = 1.0/conv_sed_ocn(io_DIC,iss_POC)
    conv_ocn_sed(iss_POC_13C,io_DIC_13C)      = 1.0/conv_sed_ocn(io_DIC_13C,iss_POC_13C)
    conv_ocn_sed(iss_POC_14C,io_DIC_14C)      = 1.0/conv_sed_ocn(io_DIC_14C,iss_POC_14C)
    conv_ocn_sed(iss_POP,io_PO4)              = 1.0/conv_sed_ocn(io_PO4,iss_POP)
    conv_ocn_sed(iss_PON,io_NO3)              = 1.0/conv_sed_ocn(io_NO3,iss_PON)
    conv_ocn_sed(iss_PON_15N,io_NO3_15N)      = 1.0/conv_sed_ocn(io_NO3_15N,iss_PON_15N)
    conv_ocn_sed(iss_PON,io_ALK)              = 1.0/conv_sed_ocn(io_ALK,iss_PON)
    conv_ocn_sed(iss_POFe,io_Fe)              = 1.0/conv_sed_ocn(io_Fe,iss_POFe)
    ...
    conv_ocn_sed(iss_POCd,io_Cd)              = 1.0/conv_sed_ocn(io_Cd,iss_POCd)
    conv_ocn_sed(iss_POCd_114Cd,io_Cd_114Cd)  = 1.0/conv_sed_ocn(io_Cd_114Cd,iss_POCd_114Cd)
    conv_ocn_sed(iss_POI,io_I)                = 1.0/conv_sed_ocn(io_I,iss_POI)
    conv_ocn_sed(iss_CaCO3,io_DIC)            = 1.0/conv_sed_ocn(io_DIC,iss_CaCO3)
    conv_ocn_sed(iss_CaCO3_13C,io_DIC_13C)    = 1.0/conv_sed_ocn(io_DIC_13C,iss_CaCO3_13C)
    conv_ocn_sed(iss_CaCO3_14C,io_DIC_14C)    = 1.0/conv_sed_ocn(io_DIC_14C,iss_CaCO3_14C)
    conv_ocn_sed(iss_CaCO3,io_ALK)            = 1.0/conv_sed_ocn(io_ALK,iss_CaCO3)
    conv_ocn_sed(iss_CaCO3,io_Ca)             = 1.0/conv_sed_ocn(io_Ca,iss_CaCO3)
    conv_ocn_sed(iss_CaCO3_44Ca,io_Ca_44Ca)   = 1.0/conv_sed_ocn(io_Ca_44Ca,iss_CaCO3_44Ca)
    conv_ocn_sed(iss_CdCO3,io_Cd)             = 1.0/conv_sed_ocn(io_Cd,iss_CdCO3)
    conv_ocn_sed(iss_CdCO3_114Cd,io_Cd_114Cd) = 1.0/conv_sed_ocn(io_Cd_114Cd,iss_CdCO3_114Cd)
    conv_ocn_sed(iss_LiCO3,io_Li)             = 1.0/conv_sed_ocn(io_Li,iss_LiCO3)
    conv_ocn_sed(iss_LiCO3_7Li,io_Li_7Li)     = 1.0/conv_sed_ocn(io_Li_7Li,iss_LiCO3_7Li)
    conv_ocn_sed(iss_detLi,io_Li)             = 1.0/conv_sed_ocn(io_Li,iss_detLi)
    conv_ocn_sed(iss_detLi_7Li,io_Li_7Li)     = 1.0/conv_sed_ocn(io_Li_7Li,iss_detLi_7Li)
    conv_ocn_sed(iss_opal,io_SiO2)            = 1.0/conv_sed_ocn(io_SiO2,iss_opal)
    conv_ocn_sed(iss_opal_30Si,io_SiO2_30Si)  = 1.0/conv_sed_ocn(io_SiO2_30Si,iss_opal_30Si)
    conv_ocn_sed(iss_opalGe,io_Ge)            = 1.0/conv_sed_ocn(io_Ge,iss_opalGe)
    conv_ocn_sed(iss_POM_Fe,io_Fe)            = 1.0/conv_sed_ocn(io_Fe,iss_POM_Fe)
    conv_ocn_sed(iss_CaCO3_Fe,io_Fe)          = 1.0/conv_sed_ocn(io_Fe,iss_CaCO3_Fe)
    conv_ocn_sed(iss_opal_Fe,io_Fe)           = 1.0/conv_sed_ocn(io_Fe,iss_opal_Fe)
    conv_ocn_sed(iss_det_Fe,io_Fe)            = 1.0/conv_sed_ocn(io_Fe,iss_det_Fe)
    conv_ocn_sed(iss_POM_231Pa,io_231Pa)      = 1.0/conv_sed_ocn(io_231Pa,iss_POM_231Pa)
    conv_ocn_sed(iss_CaCO3_231Pa,io_231Pa)    = 1.0/conv_sed_ocn(io_231Pa,iss_CaCO3_231Pa)
    conv_ocn_sed(iss_opal_231Pa,io_231Pa)     = 1.0/conv_sed_ocn(io_231Pa,iss_opal_231Pa)
    conv_ocn_sed(iss_det_231Pa,io_231Pa)      = 1.0/conv_sed_ocn(io_231Pa,iss_det_231Pa)
    conv_ocn_sed(iss_POM_230Th,io_230Th)      = 1.0/conv_sed_ocn(io_230Th,iss_POM_230Th)
    conv_ocn_sed(iss_CaCO3_230Th,io_230Th)    = 1.0/conv_sed_ocn(io_230Th,iss_CaCO3_230Th)
    conv_ocn_sed(iss_opal_230Th,io_230Th)     = 1.0/conv_sed_ocn(io_230Th,iss_opal_230Th)
    conv_ocn_sed(iss_det_230Th,io_230Th)      = 1.0/conv_sed_ocn(io_230Th,iss_det_230Th)
    conv_ocn_sed(iss_POM_Nd,io_Nd)            = 1.0/conv_sed_ocn(io_Nd,iss_POM_Nd)
    conv_ocn_sed(iss_CaCO3_Nd,io_Nd)          = 1.0/conv_sed_ocn(io_Nd,iss_CaCO3_Nd)
    conv_ocn_sed(iss_opal_Nd,io_Nd)           = 1.0/conv_sed_ocn(io_Nd,iss_opal_Nd)
    conv_ocn_sed(iss_det_Nd,io_Nd)            = 1.0/conv_sed_ocn(io_Nd,iss_det_Nd)
    conv_ocn_sed(iss_POM_Nd_144Nd,io_Nd_144Nd)   = 1.0/conv_sed_ocn(io_Nd_144Nd,iss_POM_Nd_144Nd)
    conv_ocn_sed(iss_CaCO3_Nd_144Nd,io_Nd_144Nd) = 1.0/conv_sed_ocn(io_Nd_144Nd,iss_CaCO3_Nd_144Nd)
    conv_ocn_sed(iss_opal_Nd_144Nd,io_Nd_144Nd)  = 1.0/conv_sed_ocn(io_Nd_144Nd,iss_opal_Nd_144Nd)
    conv_ocn_sed(iss_det_Nd_144Nd,io_Nd_144Nd)   = 1.0/conv_sed_ocn(io_Nd_144Nd,iss_det_Nd_144Nd)
    conv_ocn_sed(iss_POM_S,io_H2S)               = 1.0/conv_sed_ocn(io_H2S,iss_POM_S)
    conv_ocn_sed(iss_POM_S_34S,io_H2S_34S)       = 1.0/conv_sed_ocn(io_H2S_34S,iss_POM_S_34S)
    conv_ocn_sed(iss_POM_MoS2,io_Mo) = 1.0/conv_sed_ocn(io_Mo,iss_POM_MoS2)
    conv_ocn_sed(iss_POM_MoS2,io_H2S) = 1.0/conv_sed_ocn(io_H2S,iss_POM_MoS2)
    conv_ocn_sed(iss_CaCO3_MoS2,io_Mo) = 1.0/conv_sed_ocn(io_Mo,iss_CaCO3_MoS2)
    conv_ocn_sed(iss_CaCO3_MoS2,io_H2S) = 1.0/conv_sed_ocn(io_H2S,iss_CaCO3_MoS2)
    conv_ocn_sed(iss_opal_MoS2,io_Mo) = 1.0/conv_sed_ocn(io_Mo,iss_opal_MoS2)
    conv_ocn_sed(iss_opal_MoS2,io_H2S) = 1.0/conv_sed_ocn(io_H2S,iss_opal_MoS2)
    conv_ocn_sed(iss_det_MoS2,io_Mo) = 1.0/conv_sed_ocn(io_Mo,iss_det_MoS2)
    conv_ocn_sed(iss_det_MoS2,io_H2S) = 1.0/conv_sed_ocn(io_H2S,iss_det_MoS2)
    conv_ocn_sed(iss_POM_MoS2_98Mo,io_Mo_98Mo) = 1.0/conv_sed_ocn(io_Mo_98Mo,iss_POM_MoS2_98Mo)
    conv_ocn_sed(iss_POM_MoS2_34S,io_H2S_34S) = 1.0/conv_sed_ocn(io_H2S_34S,iss_POM_MoS2_34S)
    conv_ocn_sed(iss_CaCO3_MoS2_98Mo,io_Mo_98Mo) = 1.0/conv_sed_ocn(io_Mo_98Mo,iss_CaCO3_MoS2_98Mo)
    conv_ocn_sed(iss_CaCO3_MoS2_34S,io_H2S_34S) = 1.0/conv_sed_ocn(io_H2S_34S,iss_CaCO3_MoS2_34S)
    conv_ocn_sed(iss_opal_MoS2_98Mo,io_Mo_98Mo) = 1.0/conv_sed_ocn(io_Mo_98Mo,iss_opal_MoS2_98Mo)
    conv_ocn_sed(iss_opal_MoS2_34S,io_H2S_34S) = 1.0/conv_sed_ocn(io_H2S_34S,iss_opal_MoS2_34S)
    conv_ocn_sed(iss_det_MoS2_98Mo,io_Mo_98Mo) = 1.0/conv_sed_ocn(io_Mo_98Mo,iss_det_MoS2_98Mo)
    conv_ocn_sed(iss_det_MoS2_34S,io_H2S_34S) = 1.0/conv_sed_ocn(io_H2S_34S,iss_det_MoS2_34S)
    ! ############################################################################################################################ !
    ...
    conv_POM_DOM(:,:) = 0.0
    conv_POM_DOM(io_DOM_C,iss_POC)               = 1.0
    conv_POM_DOM(io_DOM_C_13C,iss_POC_13C)       = 1.0
    conv_POM_DOM(io_DOM_C_14C,iss_POC_14C)       = 1.0
    conv_POM_DOM(io_DOM_N,iss_PON)               = 1.0
    conv_POM_DOM(io_DOM_N_15N,iss_PON_15N)       = 1.0
    conv_POM_DOM(io_DOM_P,iss_POP)               = 1.0
    conv_POM_DOM(io_DOM_Cd,iss_POCd)             = 1.0
    conv_POM_DOM(io_DOM_Cd_114Cd,iss_POCd_114Cd) = 1.0
    conv_POM_DOM(io_DOM_Fe,iss_POFe)             = 1.0
    conv_POM_DOM(io_DOM_I,iss_POI)               = 1.0
    ! convert DOM -> POM
    conv_DOM_POM(:,:) = 0.0
    conv_DOM_POM(iss_POC,io_DOM_C)               = 1.0/conv_POM_DOM(io_DOM_C,iss_POC)
    conv_DOM_POM(iss_POC_13C,io_DOM_C_13C)       = 1.0/conv_POM_DOM(io_DOM_C_13C,iss_POC_13C)
    conv_DOM_POM(iss_POC_14C,io_DOM_C_14C)       = 1.0/conv_POM_DOM(io_DOM_C_14C,iss_POC_14C)
    conv_DOM_POM(iss_PON,io_DOM_N)               = 1.0/conv_POM_DOM(io_DOM_N,iss_PON)
    conv_DOM_POM(iss_PON_15N,io_DOM_N_15N)       = 1.0/conv_POM_DOM(io_DOM_N_15N,iss_PON_15N)
    conv_DOM_POM(iss_POP,io_DOM_P)               = 1.0/conv_POM_DOM(io_DOM_P,iss_POP)
    conv_DOM_POM(iss_POCd,io_DOM_Cd)             = 1.0/conv_POM_DOM(io_DOM_Cd,iss_POCd)
    conv_DOM_POM(iss_POCd_114Cd,io_DOM_Cd_114Cd) = 1.0/conv_POM_DOM(io_DOM_Cd_114Cd,iss_POCd_114Cd)
    conv_DOM_POM(iss_POFe,io_DOM_Fe)             = 1.0/conv_POM_DOM(io_DOM_Fe,iss_POFe)
    conv_DOM_POM(iss_POI,io_DOM_I)               = 1.0/conv_POM_DOM(io_DOM_I,iss_POI)
    ! ############################################################################################################################ !
    ...
    ! ### INSERT DEFINITIONS FOR ADDITIONAL DOM/POM RELATIONSHIPS HERE ########################################################### !
    conv_POM_RDOM(:,:) = 0.0
    conv_POM_RDOM(io_RDOM_C,iss_POC)               = 1.0
    conv_POM_RDOM(io_RDOM_C_13C,iss_POC_13C)       = 1.0
    conv_POM_RDOM(io_RDOM_C_14C,iss_POC_14C)       = 1.0
    conv_POM_RDOM(io_RDOM_N,iss_PON)               = 1.0
    conv_POM_RDOM(io_RDOM_N_15N,iss_PON_15N)       = 1.0
    conv_POM_RDOM(io_RDOM_P,iss_POP)               = 1.0
    conv_POM_RDOM(io_RDOM_Cd,iss_POCd)             = 1.0
    conv_POM_RDOM(io_RDOM_Cd_114Cd,iss_POCd_114Cd) = 1.0
    conv_POM_RDOM(io_RDOM_Fe,iss_POFe)             = 1.0
    conv_POM_RDOM(io_RDOM_I,iss_POI)               = 1.0
    ! convert RDOM -> POM
    conv_RDOM_POM(:,:) = 0.0
    conv_RDOM_POM(iss_POC,io_RDOM_C)               = 1.0/conv_POM_RDOM(io_RDOM_C,iss_POC)
    conv_RDOM_POM(iss_POC_13C,io_RDOM_C_13C)       = 1.0/conv_POM_RDOM(io_RDOM_C_13C,iss_POC_13C)
    conv_RDOM_POM(iss_POC_14C,io_RDOM_C_14C)       = 1.0/conv_POM_RDOM(io_RDOM_C_14C,iss_POC_14C)
    conv_RDOM_POM(iss_PON,io_RDOM_N)               = 1.0/conv_POM_RDOM(io_RDOM_N,iss_PON)
    conv_RDOM_POM(iss_PON_15N,io_RDOM_N_15N)       = 1.0/conv_POM_RDOM(io_RDOM_N_15N,iss_PON_15N)
    conv_RDOM_POM(iss_POP,io_RDOM_P)               = 1.0/conv_POM_RDOM(io_RDOM_P,iss_POP)
    conv_RDOM_POM(iss_POCd,io_RDOM_Cd)             = 1.0/conv_POM_RDOM(io_RDOM_Cd,iss_POCd)
    conv_RDOM_POM(iss_POCd_114Cd,io_RDOM_Cd_114Cd) = 1.0/conv_POM_RDOM(io_RDOM_Cd_114Cd,iss_POCd_114Cd)
    conv_RDOM_POM(iss_POFe,io_RDOM_Fe)             = 1.0/conv_POM_RDOM(io_RDOM_Fe,iss_POFe)
    conv_RDOM_POM(iss_POI,io_RDOM_I)               = 1.0/conv_POM_RDOM(io_RDOM_I,iss_POI)
  ...
  SUBROUTINE sub_def_tracer_decay()
    ...
    ! sed tracers
    const_lambda_sed(iss_POC_14C) = const_lambda_14C
    const_lambda_sed(iss_CaCO3_14C) = const_lambda_14C
    const_lambda_sed(iss_foram_p_14C) = const_lambda_14C
    const_lambda_sed(iss_foram_b_14C) = const_lambda_14C
    const_lambda_sed(iss_POM_231Pa) = const_lambda_231Pa
    const_lambda_sed(iss_POM_230Th) = const_lambda_230Th
    const_lambda_sed(iss_CaCO3_231Pa) = const_lambda_231Pa
    const_lambda_sed(iss_CaCO3_230Th) = const_lambda_230Th
    const_lambda_sed(iss_det_231Pa) = const_lambda_231Pa
    const_lambda_sed(iss_det_230Th) = const_lambda_230Th
    const_lambda_sed(iss_opal_231Pa) = const_lambda_231Pa
    const_lambda_sed(iss_opal_230Th) = const_lambda_230Th
  ...
  FUNCTION fun_recalc_tracerrelationships_i(dum_conv_sed_ocn)
    ...
    ! DUMMY ARGUMENTS
    ! -------------------------------------------------------- !
    real,dimension(1:n_ocn,1:nt_sed_all),INTENT(in)::dum_conv_sed_ocn              !
    ! -------------------------------------------------------- !
    ! RESULT VARIABLE
    ! -------------------------------------------------------- !
    integer,dimension(0:n_ocn,0:nt_sed_all)::fun_recalc_tracerrelationships_i         !
    ! -------------------------------------------------------- !
    ! DEFINE LOCAL VARIABLES
    ! -------------------------------------------------------- !
    INTEGER::io,is
    integer::loc_tot_i
    integer,dimension(0:n_ocn,0:nt_sed_all)::loc_conv_sed_ocn_i         !
    ! -------------------------------------------------------- !
    ! INITIALIZE
    ! -------------------------------------------------------- !
  ...
  FUNCTION fun_conv_sedocn2lslo(dum_sed_ocn)
    ...
    ! DUMMY ARGUMENTS
    ! -------------------------------------------------------- !
    real,dimension(n_ocn,nt_sed_all),INTENT(in)::dum_sed_ocn !
    ! -------------------------------------------------------- !
    ! RESULT VARIABLE
    ! -------------------------------------------------------- !
  ...
  FUNCTION fun_conv_sedocn2lslo_i(dum_sed_ocn_i)
    ...
    ! DUMMY ARGUMENTS
    ! -------------------------------------------------------- !
    integer,dimension(0:n_ocn,0:nt_sed_all),INTENT(in)::dum_sed_ocn_i !
    ! -------------------------------------------------------- !
    ! RESULT VARIABLE
    ! -------------------------------------------------------- !
  ...
  FUNCTION fun_conv_ocnsed2lols(dum_ocn_sed)
    ...
    ! DUMMY ARGUMENTS
    ! -------------------------------------------------------- !
    real,dimension(nt_sed_all,n_ocn),INTENT(in)::dum_ocn_sed !
    ! -------------------------------------------------------- !
    ! RESULT VARIABLE
    ! -------------------------------------------------------- !
  ...
  FUNCTION fun_conv_ocnsed2lols_i(dum_ocn_sed_i)
    ...
    ! DUMMY ARGUMENTS
    ! -------------------------------------------------------- !
    integer,dimension(0:nt_sed_all,0:n_ocn),INTENT(in)::dum_ocn_sed_i !
    ! -------------------------------------------------------- !
    ! RESULT VARIABLE
    ! -------------------------------------------------------- !
