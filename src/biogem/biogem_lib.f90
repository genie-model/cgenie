...
MODULE biogem_lib
  ...
  ! atmosphere
  LOGICAL, DIMENSION(:), ALLOCATABLE :: ocnatm_airsea_eqm
  ...
  REAL,DIMENSION(nt_sed_all)::int_fexport_sig                         !
  REAL, DIMENSION(:), ALLOCATABLE :: int_focnatm_sig
  REAL,DIMENSION(nt_sed_all)::int_focnsed_sig                         !
  ...
  REAL,DIMENSION(nt_sed_all)::int_ocnsed_sig                          !
  ...
  REAL, DIMENSION(:,:,:), ALLOCATABLE :: force_restore_atm_sig
  REAL, DIMENSION(:), ALLOCATABLE :: force_restore_atm_sig_x
  REAL, DIMENSION(:), ALLOCATABLE :: force_restore_atm_tconst
  INTEGER, DIMENSION(:,:), ALLOCATABLE :: force_restore_atm_sig_i
  LOGICAL, DIMENSION(:), ALLOCATABLE :: force_restore_atm_select
  ! forcing - flux
  ...
  REAL, DIMENSION(:,:,:), ALLOCATABLE :: force_flux_atm_sig
  REAL, DIMENSION(:), ALLOCATABLE :: force_flux_atm_sig_x
  INTEGER, DIMENSION(:,:), ALLOCATABLE :: force_flux_atm_sig_i
  LOGICAL, DIMENSION(:), ALLOCATABLE :: force_flux_atm_select
  LOGICAL, DIMENSION(:), ALLOCATABLE :: force_flux_atm_scale
  ...
  REAL,DIMENSION(nt_sed_all,2,n_data_max)::force_flux_sed_sig         !
  REAL,DIMENSION(nt_sed_all)::force_flux_sed_sig_x                    !
  INTEGER,DIMENSION(nt_sed_all,2)::force_flux_sed_sig_i               !
  LOGICAL,DIMENSION(nt_sed_all)::force_flux_sed_select                !
  LOGICAL,DIMENSION(nt_sed_all)::force_flux_sed_scale                 !
  ! forcing - misc
...
CONTAINS
  ...
  function fun_lib_conv_vsedTOsed(dum_vsed)
    ...
    ! result variable
    REAL,DIMENSION(nt_sed_all,n_i,n_j,n_k)::fun_lib_conv_vsedTOsed    !
    ! local variables
    integer::loc_i,loc_j,k,n
    integer::l,is
    integer::loc_k1
