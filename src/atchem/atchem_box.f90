...
CONTAINS
  ...
  SUBROUTINE sub_calc_terrCO2exchange(dum_i,dum_j,dum_dtyr,dum_fatm)
    ...
    loc_Ratm = atm(ias_pCO2_13C,dum_i,dum_j)/atm(ias_pCO2,dum_i,dum_j)
    loc_Rterr = atm_slabbiosphere(ias_pCO2_13C,dum_i,dum_j)/atm_slabbiosphere(ias_pCO2,dum_i,dum_j)

    ! *** EXCHANGE CO2 ***
    ! NOTE: atm_slabbiosphere in units of mol
    ! bulk CO2
    dum_fatm(ias_pCO2) = dum_fatm(ias_pCO2) + loc_Fatm - loc_Fterr
    atm_slabbiosphere(ias_pCO2,dum_i,dum_j) = &
         & atm_slabbiosphere(ias_pCO2,dum_i,dum_j) - loc_Fatm + loc_Fterr
    ! d13C
    dum_fatm(ias_pCO2_13C) = dum_fatm(ias_pCO2_13C) + loc_Rterr*loc_Fatm - loc_Ratm*loc_Fterr
    atm_slabbiosphere(ias_pCO2_13C,dum_i,dum_j) = &
         & atm_slabbiosphere(ias_pCO2_13C,dum_i,dum_j) - loc_Rterr*loc_Fatm + loc_Ratm*loc_Fterr
  ...
  SUBROUTINE sub_calc_oxidize_CH4(dum_i,dum_j,dum_dtyr)
    ...
    loc_CH4 = atm(ias_pCH4,dum_i,dum_j)
    ...
    ! *** ATMOSPHERIC CH4->CO2 ***
    atm(ias_pO2,dum_i,dum_j)      = atm(ias_pO2,dum_i,dum_j)      - 2.0*loc_fracdecay*atm(ias_pCH4,dum_i,dum_j)
    atm(ias_pCO2,dum_i,dum_j)     = atm(ias_pCO2,dum_i,dum_j)     + loc_fracdecay*atm(ias_pCH4,dum_i,dum_j)
    atm(ias_pCO2_13C,dum_i,dum_j) = atm(ias_pCO2_13C,dum_i,dum_j) + loc_fracdecay*atm(ias_pCH4_13C,dum_i,dum_j)
    atm(ias_pCO2_14C,dum_i,dum_j) = atm(ias_pCO2_14C,dum_i,dum_j) + loc_fracdecay*atm(ias_pCH4_14C,dum_i,dum_j)
    atm(ias_pCH4,dum_i,dum_j)     = (1.0 - loc_fracdecay)*atm(ias_pCH4,dum_i,dum_j)
    atm(ias_pCH4_13C,dum_i,dum_j) = (1.0 - loc_fracdecay)*atm(ias_pCH4_13C,dum_i,dum_j)
    atm(ias_pCH4_14C,dum_i,dum_j) = (1.0 - loc_fracdecay)*atm(ias_pCH4_14C,dum_i,dum_j)
  ...
  SUBROUTINE sub_calc_wetlands_CH4(dum_dtyr,dum_fatm)
    ...
    dum_fatm(ias_pCH4) = dum_fatm(ias_pCH4) + loc_flux_CH4
    IF (atm_select(ias_pCH4_13C)) THEN
       ...
       dum_fatm(ias_pCH4_13C) = dum_fatm(ias_pCH4_13C) + loc_flux_CH4_13C
       IF (atm_select(ias_pCH4_14C)) THEN
          dum_fatm(ias_pCH4_14C) = dum_fatm(ias_pCH4_14C)
       end IF
    end IF
    ...
    dum_fatm(ias_pCO2) = dum_fatm(ias_pCO2) - loc_flux_CH4
    IF (atm_select(ias_pCH4_13C) .AND. atm_select(ias_pCH4_13C)) THEN
       dum_fatm(ias_pCO2_13C) = dum_fatm(ias_pCO2_13C) - loc_flux_CH4_13C
       IF (atm_select(ias_pCO2_14C)) THEN
          dum_fatm(ias_pCO2_14C) = dum_fatm(ias_pCO2_14C)
       end IF
    end IF
    dum_fatm(ias_pO2) = dum_fatm(ias_pO2) + 2.0*loc_flux_CH4
