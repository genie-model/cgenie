function [new_topo landsea2] = gen_topo_6(blon, blat, btopo, nlon, nlat, ndep, smpar, filename, oldmask);
...
land_frac = 0.5;
[t2, olx, oly] = regrid_2d(t1, blat, blon, newlat, newlon(1:(end-1)), 0.5);
store_t2 = t2;
