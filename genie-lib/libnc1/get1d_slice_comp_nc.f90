...
!========================================
      subroutine get1d_slice_comp_nc(ncid, varname, dim1, arrayout, ifail)
      implicit none
...
!----------------------------------------
      integer :: status &                   ! return code
           ...
           & , start(1) &                   ! 1st elem. of netcdf var. read in
           & , count(1) &                   ! wanted elements in each direction
           & , ifail
!----------------------------------------
! local variables
!----------------------------------------
...
!----------------------------------------
      ...
      if (realkind.eq.4) then
        ...
        print*,'precision problem in get1d_slice_comp_nc'
        stop
      endif
      if (status .ne. nf_noerr) then
