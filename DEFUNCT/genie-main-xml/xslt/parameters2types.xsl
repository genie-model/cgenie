...
Andrew Price, $Date: 2008-02-13 10:51:19 +0000 (Wed, 13 Feb 2008) $
$Revision: 3901 $
		...
		<xsl:element name="xs:schema">
			...
			<xsl:element name="xs:annotation">
				<xsl:element name="xs:documentation">
					Auto-generated schema for module <xsl:value-of select="$typename"/>. Created by $Revision: 3901 $ of parameters2types.xsl on <xsl:value-of select="$date"/>.
				</xsl:element>
			</xsl:element>
