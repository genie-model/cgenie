...
installed packages found in other UNIX style environment such as Linux and keep
...
\mint{bash}|ruby -e "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install)"|
